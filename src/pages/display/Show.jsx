...
export const Sho = ({cit}) => {
  ...
  const [place,setplace]=useState("");
   ...
   const weu=axios("https://api.weatherapi.com/v1/current.json?key=00547835b5e84313945140812220912&q="+cit+"&aqi=no&units=metric");
    async function we() {
...
const Show = ({city,s,c}) => {
  ...
  const [place,setplace]=useState("");
   ...
   const weu=axios("https://api.weatherapi.com/v1/current.json?key=00547835b5e84313945140812220912&q="+city+","+s+","+c+"&aqi=no&units=metric");
    async function we() {
